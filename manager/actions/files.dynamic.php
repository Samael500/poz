...
function ufilesize($size) {
	...
	function translit ($text){
        $rus = array("а","А","б","Б","в","В","г","Г","д","Д","е","Е","ё","Ё","ж","Ж","з","З","и","И","й","Й","к","К","л","Л","м","М","н","Н","о","О","п","П","р","Р","с","С","т","Т","у","У","ф","Ф","х","Х","ц","Ц","ч","Ч","ш","Ш","щ","Щ","ъ","Ъ","ы","Ы","ь","Ь","э","Э","ю","Ю","я","Я","/"," ","і","І","ї","Ї","ґ","Ґ","є","Є","'");
		
        $engl = array("a","A","b","B","v","V","g","G","d","D","e","E","e","E","zh","ZH","z","Z","i","I","j","J","k","K","l","L","m","M","n","N","o","O","p","P","r","R","s","S","t","T","u","U","f","F","h","H","c","C","ch","CH","sh","SH","sch","SCH","","","y","Y","","","e","E","ju","JU","ja","JA","","","i","I","ji","JI","g","G","e","E","");

        $text = str_replace($rus,$engl,$text);
...
if(!empty($_FILES['userfile'])) {
    ...
    for ($i = 0; $i <= count($_FILES['userfile']['tmp_name']); $i++) {
        if(!empty($_FILES['userfile']['tmp_name'][$i])) {
			...
			$userfiles[$i]['type'] = translit($_FILES['userfile']['type'][$i]);
        }
    }
