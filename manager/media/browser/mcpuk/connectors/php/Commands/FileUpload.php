...
class FileUpload {
	...
	function translit ($filename) { 
		...
		"А"=>"A","Б"=>"B","В"=>"V","Г"=>"G","Д"=>"D","Е"=>"E", "Ё"=>"Yo","Ж"=>"J","З"=>"Z","И"=>"I","Й"=>"I","К"=>"K", "Л"=>"L","М"=>"M","Н"=>"N","О"=>"O","П"=>"P", "Р"=>"R","С"=>"S","Т"=>"T","У"=>"Y","Ф"=>"F", "Х"=>"H","Ц"=>"C","Ч"=>"Ch","Ш"=>"Sh","Щ"=>"Sh", "Ы"=>"I","Э"=>"E","Ю"=>"U","Я"=>"Ya", "ь"=>"","Ь"=>"","ъ"=>"","Ъ"=>""," "=>"_"," "=>"_",
		"і"=>"i","І"=>"I","ї"=>"ji","Ї"=>"Ji","є"=>"e","Є"=>"E","ґ"=>"g","Ґ"=>"G",
		" "=>"_"," "=>"_"," "=>"_");
